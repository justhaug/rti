...
# human runs: local autosaved PB replays or TMX leaderboard replays → exact inputs
./target/release/rti replay import tmx:231384          # rti map import also pulls the top TMX replays
